...
- **Decision:** Mark only the folder as deleted. Do _not_ recursively update all child files.
...
1.  **Header Actions**
    - **Empty Trash Button**: Top-Right.
      - _Hover_: Transitions to `bg-red-50 text-red-600 border-red-200`.
      - _Icon_: Trash icon that "opens" on hover.
