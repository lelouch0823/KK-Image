 ...
 */
export const PurchaseOrderReceiptReversalSchema = z.object({
 ...
 * 关闭待收明细项 Schema
 */
const ShortageClosureItemSchema = z.object({
    purchase_order_item_id: z.string().min(1, 'purchase_order_item_id 必填'),
 ...
 */
export const ShortageClosureSchema = z.object({
 ...
 */
export const CreateFromOrdersSchema = z.object({
 ...
 */
export const AddPurchaseOrderItemsSchema = z.object({
