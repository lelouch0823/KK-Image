...
export async function publishProductCacheEvent(c, eventType, productIds, { commandId, correlationId } = {}) {
    try {
...
export async function reserveProductCommand(c, {
    commandType,
    requestFingerprint,
    mismatchMessage,
    inFlightMessage,
...
export async function runIdempotentCommand(c, {
    commandType,
    requestFingerprint,
    mismatchMessage,
    inFlightMessage,
