...
describe('Product Import Variant Merge Logic', () => {
  ...
  describe('mergeIncomingWithExisting', () => {
    it('updates existing variant matching by code, keeping its ID', () => {
      const existing = [{ id: 'id-1', variant_code: 'V-001', price: 100 }];
      const incoming = [{ variant_code: 'V-001', price: 150, stock_quantity: 10 }];
    ...
    it('adds new incoming variant that does not match any existing', () => {
      const existing = [{ id: 'id-1', variant_code: 'V-001' }];
      const incoming = [{ variant_code: 'V-002', price: 150 }];
    ...
    it('preserves existing variants that are not present in incoming', () => {
      ...
      const incoming = [{ variant_code: 'V-001', price: 150 }];
    ...
    it('matches by signature correctly', () => {
      const existing = [{ id: 'id-sig', options_values: { Size: 'M', Color: 'Blue' }, price: 100 }];
      // Different order, same content
      const incoming = [{ options_values: { Color: 'Blue', Size: 'M' }, price: 120 }];
    ...
    it('does not falsely match when both variants have no code/sku/signature', () => {
      const existing = [{ id: 'id-empty', price: 100 }];
      const incoming = [{ price: 120 }];
