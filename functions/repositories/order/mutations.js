...
function buildCreateLines({ lines, data, quantity, productId, variantId, mainImageId }) {
...
function syncImplicitSingleLineData(
  data = {},
...
async function assertOrderStatusCompatibleWithLines(
  db,
  orderId,
  nextStatus,
...
async function syncCompatibilityOrderLineSnapshot(
  db,
...
function buildOrderLineInsertStatement(db, { orderId, line, status, mainImageId, timestamp }) {
