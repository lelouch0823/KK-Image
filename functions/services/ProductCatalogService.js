...
export { assertBatchItem, normalizeImportMode } from './product-catalog/batch-import.js';
export {
...
export class ProductCatalogService {
  ...
  async createProduct(c, body, options = {}) {
    const { skipCacheInvalidation = false, cacheEventCommandId, cacheEventCorrelationId } = options;
