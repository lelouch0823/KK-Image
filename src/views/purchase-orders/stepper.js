export const createPurchaseOrderSteps = (translate) => [
...
export const getStepIndex = (stepsList = [], status) =>
  stepsList.findIndex((step) => step.value === status);

export const isStepCompleted = (stepsList = [], currentStatus, stepStatus) => {
  if (currentStatus === 'cancelled') return false;
  return getStepIndex(stepsList, currentStatus) > getStepIndex(stepsList, stepStatus);
};

export const getStepperProgress = (stepsList = [], currentStatus) => {
...
export const getStepIconClasses = (stepsList = [], currentStatus, stepStatus) => {
