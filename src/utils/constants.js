...
export const API = {
  ...
  MANAGE_ORDER_DELIVERY_CONFIRM: (id) => `/api/manage/orders/${id}/delivery-confirmation`,
  ...
  MANAGE_ORDER_LINE_UNSHIP: (id, lineId) => `/api/manage/orders/${id}/lines/${lineId}/unship`,
  MANAGE_ORDER_LINE_RETURN: (id, lineId) => `/api/manage/orders/${id}/lines/${lineId}/return`,
