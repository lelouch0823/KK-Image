...
export function parseAuditJson(value: any, fallback: any = null): any {
  if (!value) return fallback;
  if (typeof value === 'object') return value;
  return safeParseJson(value, fallback);
}

export function formatAuditSummary(row: any = {}): string {
...
export function normalizeAuditRow(row: any = {}): any {
