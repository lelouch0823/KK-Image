...
export default {
  ...
  form: {
    ...
    option_color_placeholder: 'Add color (e.g., Red)',
    option_values_placeholder: 'Add spec (e.g., XL, M...)',
    select_color: 'Select Color',
    edit_color: 'Click to edit color',
    dimension_label: 'Dimension Name',
    dimension_label_short: 'Dimension',
    option_values: 'Option Values',
    option_values_label: 'Options / Values',
    values_count: 'Values',
  ...
  import: {
    ...
    stats: {
      ...
      all_failed: 'All {failed} imports failed',
    },
  ...
  categoryTree: {
    ...
    all: 'All Products',
    set_products: 'Set Category Products',
    set_products_desc: 'Select products belonging to this category',
  },
  price_rules: {
    title: 'Tiered Pricing',
    subtitle: 'Manage retail, wholesale, and VIP prices',
    no_variants: 'Please add product variants first',
    base_price: 'Base Price',
    add: 'Add Price',
    no_rules: 'No price rules, using base price',
    type_retail: 'Retail',
    type_wholesale: 'Wholesale',
    type_vip: 'VIP',
    valid_from: 'Start Date',
    valid_to: 'End Date',
    save_success: 'Price rules saved',
    save_failed: 'Failed to save price rules',
    delete_success: 'Price rule deleted',
