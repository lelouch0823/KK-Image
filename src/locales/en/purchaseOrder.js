...
export default {
  ...
  action: {
    ...
    closeOutstanding: 'Close Outstanding',
  },
  ...
  ui: {
    ...
    receiptLedgerMeta: 'Supports partial receipts and full reversals',
    receiptReceivableLines: 'Receivable',
    receiptRecordId: 'Receipt ID',
    receiptReversalCount: 'Reversals',
    receiptReversedTag: 'Reversed',
    receiptReversibleTag: 'Reversible',
    receiptRecordedTag: 'Recorded',
    receiptLastReversedAt: 'Last Reversal',
    availableReversalQty: 'Reversible',
    reversedQty: 'Reversed',
  },
