export default {
  ...
  dashboard: {
    ...
    actionNeeded: '需立即处理',
    vsYesterday: '较昨日',
    acrossProjects: '跨多个项目',
    awaitingAction: '等待处理',
    shareFile: '分享文件',
    viewHistory: '查看历史',
    viewAllPending: '查看全部',
    browseAllFiles: '浏览所有文件',
    noActiveSharesDesc: '创建分享链接后，此处将显示活跃动态。',
    noRecentFilesDesc: '您上传或修改的文件将出现在这里以便快速访问。',
    footer: '© 2024 KK Life 管理后台。保留所有权利。',
  },
  stats: {
    analyzing: '正在分析数据...',
    loadFailed: '数据加载失败',
  ...
  product: {
    ...
    import: {
      ...
      file_limits: '支持 .xlsx, .csv 格式', // Removed (Max 500 rows) since we support more
      total_rows: '识别行数',
