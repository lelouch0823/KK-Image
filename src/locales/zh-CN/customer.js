...
export default {
  ...
  import: {
    ...
    step1: '上传文件',
    step2: '预览确认',
    uploadHint: '点击或拖拽 Excel / CSV 文件到此处',
    fileFormats: '支持 .xlsx / .xls / .csv 格式',
    preview: '数据预览',
    previewDesc: '以下显示前 {count} 行数据，共 {total} 行',
    valid: '有效',
    errors: '错误',
    errorNameRequired: '客户名称不能为空',
    errorInvalidEmail: '邮箱格式不正确',
    success: '成功导入 {imported} 个客户',
    skipped: '，跳过 {count} 个重复客户',
    confirmImport: '确认导入',
    importing: '导入中...',
