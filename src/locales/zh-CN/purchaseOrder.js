...
export default {
  ...
  ui: {
    ...
    shortageSelectedQty: '已填关闭数量',
    shortageSubmitting: '提交中...',
    ...
    receiptLedgerMeta: '支持部分到货与整笔冲销',
    receiptReceivableLines: '待收行',
    receiptRecordId: '收货记录',
    receiptReversalCount: '冲销次数',
    receiptReversedTag: '已冲销',
    receiptReversibleTag: '可冲销',
    receiptRecordedTag: '已入账',
    receiptLastReversedAt: '最近冲销',
    availableReversalQty: '可冲销量',
    reversedQty: '已冲销',
  },
