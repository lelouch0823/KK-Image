<template>
  <div class="bg-white rounded-xl shadow-sm border border-gray-200">
    ...
    <div class="overflow-x-auto">
      <!-- 桌面表格视图 (lg+) -->
      <table class="hidden lg:table w-full text-sm text-left">
      ...
      <div class="lg:hidden p-4 space-y-3">
        <!-- 加载状态 -->
        <div v-if="loading" v-for="i in 3" :key="i" class="bg-gray-50 rounded-xl p-4 animate-pulse">
            ...
            <div class="p-4">
              <div class="flex items-start justify-between">
                ...
                <span 
                  ...
                  :class="person.isActive ? 'bg-green-100 text-green-700' : 'bg-gray-200 text-gray-600'"
                >
                  {{ person.isActive ? t('salesperson.active') : t('salesperson.disabled') }}
                </span>
              </div>
              ...
              <div class="mt-3 grid grid-cols-2 gap-2 text-sm">
                ...
                <div>
                  ...
                  <span class="ml-1 px-1.5 py-0.5 rounded bg-blue-50 text-blue-700 text-xs font-medium">{{ person.orderCount }}</span>
                </div>
              </div>
            </div>
