    ...
    <div class="fixed top-4 right-4 z-[1000] flex flex-col gap-2 pointer-events-none">
      <transition-group name="slide-up">
        <div v-for="toast in toasts" :key="toast.id" 
          class="pointer-events-auto flex items-center w-full max-w-xs p-4 bg-white rounded-lg shadow-xl border border-[var(--border-color)]" 
          role="alert">
          ...
          <div class="ml-3 text-sm font-normal text-gray-700">{{ toast.message }}</div>
