        ...
        <AppCard padding="p-4" class="space-y-5">
          ...
          <div class="space-y-2">
            ...
            <div v-if="form.PRINT_COMPANY_LOGO" class="mt-2 flex items-center gap-3">
              ...
              />
              <span v-if="logoError" class="text-xs text-red-500">
        ...
        <AppCard padding="p-4">
          ...
          >
            <div class="flex items-start justify-between border-b-2 pb-2" :style="{ borderColor: form.PRINT_TEMPLATE_ACCENT_COLOR }">
              ...
              <div class="text-right text-[10px] text-gray-500">#ORDER-001</div>
            </div>
            <div class="mt-2 text-[11px] text-gray-700">
              {{ t('settings.printTemplate.previewContent', 'Document content area...') }}
            </div>
            <div v-if="form.PRINT_FOOTER_TEXT" class="mt-2 border-t border-gray-200 pt-1 text-center text-[9px] text-gray-400">
