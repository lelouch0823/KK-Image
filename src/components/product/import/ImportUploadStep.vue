  ...
  <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
    <div class="space-y-4 lg:col-span-1">
      ...
      <div class="rounded-xl border border-(--border-color) bg-(--bg-muted) p-4">
        <p class="mb-2 text-xs font-semibold text-(--text-main)">
          {{ t('product.import.upload_rules', '导入建议') }}
        </p>
    ...
    <div class="lg:col-span-2">
      ...
      >
        ...
        <div class="text-center">
          ...
          <div
            class="mt-4 inline-flex items-center gap-2 rounded-full border border-(--border-color) bg-(--bg-card) px-3 py-1 text-xs text-(--text-secondary)"
          >
