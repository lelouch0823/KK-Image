<template>
  <div class="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-3">
    <!-- Total Products -->
    <div class="group relative overflow-hidden rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-card)] p-5 shadow-lg backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-[var(--color-info)]/10 hover:shadow-xl sm:p-6">
      <div class="relative z-10 flex items-start justify-between">
        ...
        <div class="flex size-10 items-center justify-center rounded-xl bg-[var(--color-info)]/10 text-[var(--color-info)] transition-colors group-hover:bg-[var(--color-info)] group-hover:text-[var(--text-inverse)] sm:size-12">
           <svg xmlns="http://www.w3.org/2000/svg" class="size-5 transition-transform duration-300 group-hover:scale-110 sm:size-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <!-- Low Stock Alert -->
    <div class="group relative overflow-hidden rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-card)] p-5 shadow-lg backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-[var(--color-warning)]/10 hover:shadow-xl sm:p-6">
      <div class="relative z-10 flex items-start justify-between">
        <div>
    ...
    <!-- Total Value (Est) -->
    <div class="group relative overflow-hidden rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-card)] p-5 shadow-lg backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-[var(--color-success)]/10 hover:shadow-xl sm:p-6">
      <div class="relative z-10 flex items-start justify-between">
        <div>
