      ...
      <div class="rounded-2xl border border-[var(--border-color)] bg-white p-8 shadow-lg">
        ...
        <form @submit.prevent="handleSubmit">
          ...
          <button
            type="submit"
            :disabled="loading"
            class="bg-primary flex h-12 w-full items-center justify-center rounded-xl font-medium text-white transition-colors hover:bg-[var(--color-primary-hover)] disabled:opacity-50"
          >
            <svg
              v-if="loading"
