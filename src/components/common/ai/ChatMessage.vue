<template>
  <div>
    ...
    <div :class="['flex', message.role === 'user' ? 'justify-end' : 'justify-start']">
      <div
        ...
        :class="[
          ...
          message.role === 'user'
            ? 'bg-primary shadow-primary/20 rounded-br-none font-medium text-[var(--text-inverse)]'
            : 'rounded-bl-none border border-[var(--border-color)] bg-[var(--bg-card)] text-[var(--text-main)] shadow-sm'
        ]"
      >
    ...
    <div v-if="isThinking || toolStatus" class="flex justify-start">
      <div class="rounded-2xl rounded-bl-none border border-[var(--border-color)] bg-[var(--bg-card)] px-4 py-3 shadow-sm">
